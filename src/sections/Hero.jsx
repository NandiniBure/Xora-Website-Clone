...
const Hero = () => {
  return <section className="relative border-2 pt-60 pb-40 
   max-lg:pt-52 max-lg:pb-36 max-md:pb-32  ">
    <Element name="hero">
    <div className="container">
     ...
     We designed XORO AI video Editing to be an easy to use , quick 
     to learn , and surprisingly powerful.</p>
