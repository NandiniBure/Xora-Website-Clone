 ...
 const[activeId,setActiveId]=useState(null);
  ...
  return <div className="relative z-2 mb-16">
    ...
    onClick={()=>{setActiveId(activeId===item.id ? null : item.id)}}
     className="group relative flex corsor-pointer items-center justify-center gap-10 px-7">
        <div className="flex-1">
            ...
            active && 'max-lg:text-p1' )}>{item.question}</div>
        </div>
        <div className={clsx("faq-icon relative flex size-12 items-center justify-center rounded-full border-2 shadow-400 transition-all duration-500 group-hover:border-s4",
